          ...
          <div className="c-article__content cell small-11 medium-12 large-10 xlarge-10">
            ...
            <div className="c-article__tags">
              ...
              (!data.nodeArticle.relationships.field_tags) ? null
                : data.nodeArticle.relationships.field_tags.map((tag, index) => (
                  <span key={tag.path.alias}>
                    <Link key={tag.path.alias} to={`/tags${tag.path.alias}`}>
                      {`${tag.name}`}
                    </Link>
                    {(index + 1 !== data.nodeArticle.relationships.field_tags.length) ? <span>,&nbsp;</span> : ''}
                  </span>
                ))
            }
            </div>
              ...
              <div className="c-article__related-post">
                <div className="">
                  ...
                  <div className="grid-x grid-margin-x">
                    {data.nodeArticle.relationships.field_related_post.map(node => (
